...
```{r}
save.image("data/rstanarm.RData")
```
...
```{r}
deploy_shinystan(sso, "rstanarmapp", account = 'blakeobeans')
```

### MCMC Diagnostics

Two kinds: NUTS diagnostics and general MCMC.

#### NUTS diagnostics

```{r}
lp_ncp <- log_posterior(m1)
np_ncp <- nuts_params(m1)
```
